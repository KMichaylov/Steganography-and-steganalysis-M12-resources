...
columns = ["Name", "Color", "Mean Size", "Standard Deviation Size", "Deviation from non-stego Size", "Mean MSE",
           "Standard Deviation MSE", "Deviation from non-stego MSE",
           "Mean PSNR", "Standard Deviation PSNR", "Deviation from non-stego PSNR"]
...
for i in range(0, 3):
    ...
    with open(location_for_results, 'w', newline='') as file:
        ...
        for j in range(0, 31, 2):
            ...
            row.append(deviation_from_non_stego_mse)
            ...
            row.append(deviation_from_non_stego_psnr)
